...
**
** Created: Mon Jun 27 13:59:35 2005
    ...
    : QDialog( parent, name, modal, fl )
{
    ...
    aboutTab = new QTabWidget( this, "aboutTab" );

    Widget8 = new QWidget( aboutTab, "Widget8" );
    ...
    aboutTab->insertTab( Widget8, QString::fromLatin1("") );

    Widget9 = new QWidget( aboutTab, "Widget9" );

    aboutTextLabel = new QLabel( Widget9, "aboutTextLabel" );
    aboutTextLabel->setGeometry( QRect( 160, 100, 137, 110 ) );
    aboutTab->insertTab( Widget9, QString::fromLatin1("") );

    tbMainWindowLayout->addWidget( aboutTab, 1, 0 );
    ...
    languageChange();
    resize( QSize(756, 527).expandedTo(minimumSizeHint()) );
    ...
    connect( tbMainWindowResultsListView, SIGNAL( doubleClicked(QListViewItem*) ), this, SLOT( tbMainWindowResultsListView_doubleClicked(QListViewItem*) ) );
    connect( tbMainWindowResultsListView, SIGNAL( doubleClicked(QListViewItem*,const QPoint&,int) ), this, SLOT( tbMainWindowResultsListView_doubleClicked(QListViewItem*,const QPoint&,int) ) );
    connect( aboutTextLabel, SIGNAL( destroyed(QObject*) ), this, SLOT( aboutTextLabel_destroyed(QObject*) ) );
}
...
void tbMainWindow::languageChange()
{
    ...
    aboutTab->changeTab( Widget8, tr( "Search" ) );
    aboutTextLabel->setText( trUtf8( "\x3c\x62\x3e\x4a\x65\x73\x70\x65\x72\x20\x54\x68\x6f\x6d\x73\x63\x68\xc3\xbc\x74\x7a\x3c\x2f\x62\x3e\xa\x3c\x62\x72\x3e\xa\x65\x76\x69\x6c\x68\x61\x78\x30\x72\x40\x67\x6d\x61\x69\x6c\x2e\x63\x6f\x6d" ) );
    aboutTab->changeTab( Widget9, tr( "&About" ) );
}
...
void tbMainWindow::tbMainWindowResultsListView_doubleClicked(QListViewItem*)
{
    qWarning( "tbMainWindow::tbMainWindowResultsListView_doubleClicked(QListViewItem*): Not implemented yet" );
}

void tbMainWindow::tbMainWindowResultsListView_doubleClicked(QListViewItem*,const QPoint&,int)
{
    qWarning( "tbMainWindow::tbMainWindowResultsListView_doubleClicked(QListViewItem*,const QPoint&,int): Not implemented yet" );
}

void tbMainWindow::aboutTextLabel_destroyed(QObject*)
{
    qWarning( "tbMainWindow::aboutTextLabel_destroyed(QObject*): Not implemented yet" );
}
