...
**
** Created: Wed Jun 8 00:52:20 2005
...
QMetaObject* tbMainWindowImpl::staticMetaObject()
{
	...
	{ 0, &static_QUType_ptr, "searchResult", QUParameter::In }
    };
    static const QUMethod slot_4 = {"addResultToGui", 1, param_slot_4 };
    static const QUParameter param_slot_5[] = {
	{ 0, &static_QUType_ptr, "QCustomEvent", QUParameter::In }
    };
    static const QUMethod slot_5 = {"customEvent", 1, param_slot_5 };
	...
	{ "addResultToGui(searchResult)", &slot_4, QMetaData::Public },
	{ "customEvent(QCustomEvent*)", &slot_5, QMetaData::Public }
    };
...
bool tbMainWindowImpl::qt_invoke( int _id, QUObject* _o )
{
    ...
    case 4: addResultToGui((searchResult)(*((searchResult*)static_QUType_ptr.get(_o+1)))); break;
    case 5: customEvent((QCustomEvent*)static_QUType_ptr.get(_o+1)); break;
    default:
