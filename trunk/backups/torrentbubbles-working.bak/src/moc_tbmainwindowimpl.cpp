...
**
** Created: Wed May 25 19:57:53 2005
...
QMetaObject* tbMainWindowImpl::staticMetaObject()
{
    ...
    static const QUMethod slot_3 = {"changed", 1, param_slot_3 };
    static const QUParameter param_slot_4[] = {
	{ 0, &static_QUType_bool, 0, QUParameter::In }
    };
    static const QUMethod slot_4 = {"done", 1, param_slot_4 };
	...
	{ "changed(int)", &slot_3, QMetaData::Public },
	{ "done(bool)", &slot_4, QMetaData::Public }
    };
...
bool tbMainWindowImpl::qt_invoke( int _id, QUObject* _o )
{
    ...
    case 3: changed((int)static_QUType_int.get(_o+1)); break;
    case 4: done((bool)static_QUType_bool.get(_o+1)); break;
    default:
